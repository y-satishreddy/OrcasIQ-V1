import { actvitiesData, bannerData, certificateData, courseBenefitsData, faqData, priceData, salaryAnalysisData, toolsData } from "./DataAnalyticsData.js"; // correct casing + name
