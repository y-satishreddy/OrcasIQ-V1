...
const GetInTouch = () => {
  return (
    <Layout>
      <div className="w-full px-[5%] py-[3%] bg-white h-[90vh] flex flex-col md:flex-row justify-between items-center gap-12">
        {/* Left Section */}
        <div className="md:w-1/2 space-y-8 flex flex-col justify-center animate-fade-in">
          <div>
            ...
            <p className="text-gray-700 text-md mb-2">
              Fill out the form to get started. We'll reach out and guide you
              through your course options.
            </p>
          ...
          <div className="bg-[#08385f] text-white p-6 rounded-xl shadow-xl max-w-md">
            <h2 className="text-xl font-bold mb-2">
              Ready to Learn with OrcasIQ?
            </h2>
            <p className="text-sm mb-4">
              Discover programs tailored to students, professionals, and
              lifelong learners. Browse our full course list and find the right
